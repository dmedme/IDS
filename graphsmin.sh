...
set ylabel "'"'"Requests in Minute"'"'" offset 2 font  'sans,12'
set y2label "'"'"Average Response/Seconds in Minute"'"'" offset 1 font  'sans,12'
...
set timefmt "'"'"%Y-%m-%d %H:%M"'"'"
set xlabel "'"'"Date Time"'"'" offset 1 font  'sans,12'
set ylabel "'"'"Bytes in Minute"'"'" offset 2 font  'sans,12'
set y2label "'"'"Average Response/Seconds in Minute"'"'" offset 1 font  'sans,12'
...
set timefmt "'"'"%Y-%m-%d %H:%M"'"'"
set xlabel "'"'"Date Time"'"'" offset 1 font  'sans,12'
set ylabel "'"'"Users in Minute"'"'" offset 1 font  'sans,12'
set y2label "'"'"Average Response/Seconds in Minute"'"'" offset 1 font  'sans,12'
